        ...
        {activeTab === 'media' && (
          <div className="space-y-4">
            ...
            <div className="border-2 border-dashed border-neutral-300 rounded-lg p-8 text-center hover:border-primary-400 transition-colors">
              ...
              <p className="text-neutral-600">Drag & drop images here, or click to browse</p>
              <Button
                variant="secondary"
                size="sm"
                className="mt-3"
            ...
            {isUploading && (
              <div className="space-y-2">
                ...
                <div className="w-full bg-neutral-200 rounded-full h-2">
                  <div className="bg-primary-600 h-2 rounded-full transition-all duration-300" style={{ width: '67%' }} />
                </div>
              </div>
            )}
          </div>
